...
def downgrade():
    ...
    with op.batch_alter_table("tank", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("custom_cost", sa.INTEGER(), autoincrement=False, nullable=True)
        )
        batch_op.add_column(
            sa.Column("faction_id", sa.BIGINT(), autoincrement=False, nullable=True)
        )
        batch_op.create_foreign_key(
            "tank_faction_id_fkey", "faction", ["faction_id"], ["faction_id"]
        )
    ...
    with op.batch_alter_table("structure", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "structure_faction_id_fkey", "faction", ["faction_id"], ["faction_id"]
        )
    ...
    with op.batch_alter_table("plane", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "plane_faction_id_fkey", "faction", ["faction_id"], ["faction_id"]
        )
    ...
    with op.batch_alter_table("infantry", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "infantry_faction_id_fkey", "faction", ["faction_id"], ["faction_id"]
        )
    ...
    with op.batch_alter_table("boat", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "boat_faction_id_fkey", "faction", ["faction_id"], ["faction_id"]
        )
